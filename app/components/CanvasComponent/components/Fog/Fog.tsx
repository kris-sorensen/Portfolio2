...
const Fog = () => {
  ...
  const fogFar = useRef(800); // Initial far value
  ...
  useEffect(() => {
    ...
    targetFogColor.current.set(
      Page2PropsActive ? "rgb(195, 233, 251)" : "#070707"
    );
    // targetFogNear.current = Page2PropsActive ? 900 : 100;
    // targetFogFar.current = Page2PropsActive ? 1000 : 800;
